                ...
                <Form>

                  {
                    ...
                    <Form.Group className="mb-3" controlId="formBasicName">
                      <div className='text-danger'>*please provide a valid username contain at least 5 characters*</div>
                  ...
                  {
                    !auths && <div className='text-danger'>*Please provide valid email*</div>
                  }
                  ...
                  {
                    !auths && <div className='text-danger'>*please provide a valid Password contain at least 5 characters*</div>
                  }
                    ...
                    insideRegister ?
                      ...
                      <div>
                        <button onClick={handleLogin} className='btn btn-light mb-2'>Login
                          {loginStatus && <Spinner animation="border" variant="danger" />}
